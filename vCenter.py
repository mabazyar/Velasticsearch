"""
This module is to connect to the given vCenter in order for us
to retrieve almost all the statistics from.
"""
            ...
            for cluster in clusters:  # Iterate through the clusters in the DC
                ...
                for host in hosts:  # Iterate through Hosts in the Cluster
                    ...
                    for vm in vms:  # Iterate through each VM on the host
                        ...
                        vmSerializedData = {"name": vmname, "vcpus": vcpus, "memory": memory,
                                            "network": network, "os": os, "path": path,
                                            "comment": annotation, "state": state, "disk": disk,
